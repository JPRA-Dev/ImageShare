        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
          <div class="px-6">
            <div class="flex flex-wrap justify-center">
              <div class="w-full lg:w-4/12 md:w-6/12 px-4 lg:order-3 lg:text-right lg:self-center">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8"
                  action="/editProfileInfo" method="POST">
                    ...
                    @if($errors->has('name'))
                      <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block">{{ $errors->first('name') }}</span>
                    ...
                    <div class="flex flex-wrap">
                      ...
                      <input id="firstName" type="text" class="form-input w-full"
                          name="firstName" value="{{ $user->firstName }}">
                    </div>

                    @if($errors->has('firstName'))
                      <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block">{{ $errors->first('firstName') }}</span>
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3"></span>
                      </div>
                    @endif
                  ...
                  <div class="flex flex-wrap">
                    ...
                    <input id="lastName" type="text" class="form-input w-full"
                        name="lastName" value="{{ $user->lastName }}">
                  </div>

                  @if($errors->has('lastName'))
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                      <span class="block">{{ $errors->first('lastName') }}</span>
                      <span class="absolute top-0 bottom-0 right-0 px-4 py-3"></span>
                    </div>
                  @endif
                  ...
                  {{-- town --}}
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="town" type="text" class="form-input w-full"
                            name="town" value="{{ $user->town }}">
                    </div>

                    @if($errors->has('town'))
                      <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block">{{ $errors->first('town') }}</span>
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3"></span>
                      </div>
                    @endif
                    ...
                    <div class="flex flex-wrap">
                      ...
                      <input id="country" type="text" class="form-input w-full"
                          name="country" value="{{ $user->country }}">
                    </div>

                    @if($errors->has('country'))
                      <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block">{{ $errors->first('country') }}</span>
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3"></span>
                      </div>
                    @endif
                  ...
                  <div class="flex flex-wrap">
                    ...
                    <input id="work" type="text" class="form-input w-full"
                        name="work" value="{{ $user->work }}">
                  </div>  
                  
                  @if($errors->has('work'))
                      <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block">{{ $errors->first('work') }}</span>
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3"></span>
                      </div>
                  @endif
                  ...
                  <div class="flex flex-wrap">
                    ...
                    <input id="website" type="url" class="form-input w-full"
                        name="website" value="{{ $user->website }}">
                  </div>

                  @if($errors->has('website'))
                      <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block">{{ $errors->first('website') }}</span>
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3"></span>
                      </div>
                  @endif
