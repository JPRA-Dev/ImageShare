          ...
          <div class="px-6">
            ...
            <div class="text-center mt-12">
              ...
              <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
                ...
                {{Auth::user()->town}}, {{Auth::user()->country}}
              </div>
              <div class="mb-2 text-blueGray-600 mt-10">
                <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i>{{Auth::user()->work}}
              </div>
              <div class="mb-2 text-blueGray-600">
                <i class="fas fa-link mr-2 text-lg text-blueGray-400"></i>{{Auth::user()->website}}
              </div>
            </div>
