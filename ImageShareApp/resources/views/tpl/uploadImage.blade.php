      ...
      <div class="px-6">
        <div class="flex flex-wrap justify-center">
          <div class="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
            ...
            <div class="flex flex-wrap">
            {{Form::text('title','',array('placeholder'=>'Please insert your title here', 'class'=>"block text-gray-700 text-sm font-bold mb-2 sm:mb-4"))}}
            </div>
            <div class="flex flex-wrap">
            {{Form::file('image', array('class'=>"block text-gray-700 text-sm font-bold mb-2 sm:mb-4"))}}
            </div>
            <div class="flex flex-wrap">
              {{Form::text('description','',array('placeholder'=>'Please give a little description', 'class'=>"block text-gray-700 text-sm font-bold mb-2 sm:mb-4"))}}
              </div>
            <div class="flex flex-wrap">
